      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            See Vibe in
            <br />
            <span className="gradient-primary bg-clip-text text-transparent">action</span>
          </h2>
          ...
          <Card className="bg-code-bg border-primary/20 shadow-card overflow-hidden relative">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="ml-4 text-sm text-muted-foreground font-mono">fibonacci.js</span>
              </div>
              <motion.div 
                ...
                <Card className="bg-accent/10 border-accent/30 shadow-glow">
                  ...
                  >
                    ...
                    <p className="text-xs text-muted-foreground">
                      Consider using memoization to optimize recursive fibonacci. 
...
function formatCode(code: string): string {
  return code
    .replace(/\b(function|const|return|if|export|default|useMemo)\b/g, '<span style="color: hsl(var(--code-keyword))">$1</span>')
    .replace(/\b(\d+)\b/g, '<span style="color: hsl(var(--code-number))">$1</span>')
    .replace(/(\/\/.*$)/gm, '<span style="color: hsl(var(--code-comment))">$1</span>')
    .replace(/(['"`])(.*?)\1/g, '<span style="color: hsl(var(--code-string))">$1$2$1</span>')
    .replace(/\b(fibonacci|fib|memoizedFib|cache)\b/g, '<span style="color: hsl(var(--code-function))">$1</span>');
}