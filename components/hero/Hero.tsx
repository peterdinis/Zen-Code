...
import { ArrowRight, Download, Github, Play, Code2, Zap, Heart, Star } from "lucide-react";
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center gradient-hero overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-cyan-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60 h-60 bg-pink-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '4s' }} />
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                >
                  ...
                  <span className={`ml-2 transition-transform duration-300 ${isHovered ? 'translate-x-1' : ''}`}>
                ...
                <p className="text-xl text-gray-300 max-w-lg leading-relaxed">
                  Experience the most intuitive code editor ever built. With AI-powered autocomplete, 
                  stunning themes, and performance that will blow your mind.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-8 pt-8">
                {[
                  { value: "100K+", label: "Developers", color: "text-purple-400" },
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div className="text-sm text-white font-semibold">Lightning Fast</div>
                  ...
                  >
                    ...
                    <div className="text-sm text-white font-semibold">Smart Coding</div>
                  ...
                  >
                    ...
                    <div className="text-sm text-white font-semibold">Developer Love</div>
                    <div className="text-xs text-gray-400">5★ rated</div>
                  </div>
                  
                  <div 
                    className="glass-effect rounded-xl p-4 transform transition-all duration-300 hover:scale-105"
                    style={{ animation: 'float 4s ease-in-out infinite', animationDelay: '4s' }}
                  >
                    <Star className="text-cyan-400 mb-2" size={24} />
                    <div className="text-sm text-white font-semibold">Premium Feel</div>
